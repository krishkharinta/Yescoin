...
8888888b.   .d88888b. 8888888 888b    888 888    d8P  
888  "Y88b d88P" "Y88b  888   8888b   888 888   d8P   
888    888 888     888  888   88888b  888 888  d8P    
888    888 888     888  888   888Y88b 888 888d88K     
888    888 888     888  888   888 Y88b888 8888888b    
888    888 888     888  888   888  Y88888 888  Y88b   
888  .d88P Y88b. .d88P  888   888   Y8888 888   Y88b  
8888888P"   "Y88888P" 8888888 888    Y888 888    Y88b 
                                                      
                                                      
                                                      
          """)
    print(Fore.GREEN + Style.BRIGHT + "YesCoin (Gold) BOT")
    print(Fore.GREEN + Style.BRIGHT + "Update Link: https://github.com/Krishkharinta/yescoin")
    print(Fore.YELLOW + Style.BRIGHT + " Join Telegram Channel: https://t.me/Cryptonian")
    print(Fore.BLUE + Style.BRIGHT + "BKL")
